...
export const LikeButton = ({ isLiked: externalIsLiked = false, onToggle }: LikeButtonProps) => {
  ...
  return (
    <Tooltip label={externalIsLiked ? "Quitar de favoritos" : "Agregar a favoritos"}>
    <Button variant={"ghost"} size={"icon"}
      ref={iconButtonRef}
      type="button"
       onClick={toggleLike}
      aria-label={externalIsLiked ? "Quitar de favoritos" : "Agregar a favoritos"}
    >
